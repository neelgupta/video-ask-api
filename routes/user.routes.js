...
router.post("/sign-in", validateRequest(userValidation.signInValidator), userController.signIn)
...
router.put("/get-by-aggregation", isAuthenticated, userController.fetchAllAggregation)
