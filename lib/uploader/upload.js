        ...
        const uploadStream = cloudinary.uploader.upload_stream(
            {
                ...
                folder: folderPath, // Specify folder name
                public_id: randomName, // Set the random name
                use_filename: false, // Ensure the public_id is used directly
                eager: [
                    {
                        resource_type: 'image', // Generate thumbnail
                        format: 'jpg', // Specify thumbnail format
                        transformation: [
                            { width: 300, height: 200, crop: 'fill' }, // Set thumbnail dimensions
                        ],
                    },
                ],
            },
